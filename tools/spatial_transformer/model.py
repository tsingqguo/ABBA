...
from tools.spatial_transformer.vision_transforms import apply_transform_to_batch, vec_to_perpective_matrix
...
class STN(nn.Module):
    def __init__(self, transformer_module, params, P_init):
        super().__init__()
