...
then
    ...
    do
        ...
        do
            ...
            #
            deblurredfold="eplison_${translation}_${kernelsize}_stepsize_10_blur_strategy_joint_deblurganv2"
            #
            echo $dataroot$deblurredfold
            #
            mkdir $dataroot$deblurredfold
            #
            python predict.py --img_pattern $dataroot$blurredfold --out_dir $dataroot$deblurredfold
        done
    done
elif [ $1 == 'mbAdv_once' ]
then
    ...
    dataroot=/path of project/results/dev/inceptionv3_inceptionv3_mbAdv_mifgsm/
    #
    blurredfold="eplison_0.4_15.0_stepsize_10_blur_strategy_joint"
    #
    deblurredfold="eplison_0.4_15.0_stepsize_10_blur_strategy_joint_deblurganv2"
    #
    echo $dataroot$deblurredfold
    #
    mkdir $dataroot$deblurredfold
...
then
    ...
    do
        ...
        do
            ...
            #
            deblurredfold="eplison_${translation}_${kernelsize}_stepsize_10_blur_strategy_umot_whole_deblurganv2"
            #
            echo $dataroot$deblurredfold
            #
            mkdir $dataroot$deblurredfold
...
then
    ...
    #
    deblurredfold="eplison_0.4_15.0_stepsize_10_blur_strategy_$2_deblurganv2"
    #
    echo $dataroot$deblurredfold
    #
    mkdir $dataroot$deblurredfold
...
then
    dataroot=/path of project/results/dev/inceptionv3_inceptionv3_fgsm/
     #
    blurredfold="eplison_0.3_stepsize_1.0_blur_strategy_$2"
     #
    deblurredfold="eplison_0.3_stepsize_1.0_blur_strategy_$2_deblurganv2"
     #
    echo $dataroot$deblurredfold
     #
    mkdir $dataroot$deblurredfold
...
then
    ...
    blurredfold="eplison_0.3_stepsize_0.03_blur_strategy_$2"
     #
    deblurredfold="eplison_0.3_stepsize_0.03_blur_strategy_$2_deblurganv2"
     #
    echo $dataroot$deblurredfold
     #
    mkdir $dataroot$deblurredfold
...
then
    ...
    blurredfold="eplison_1.0_stepsize_0.008_blur_strategy_$2"
     #df d
    deblurredfold="eplison_1.0_stepsize_0.008_blur_strategy_$2_deblurganv2"
     #
    echo $dataroot$deblurredfold
     #
    mkdir $dataroot$deblurredfold
